...
def build_parser() -> argparse.ArgumentParser:
    ...
    bootstrap = sub.add_parser(
        "bootstrap",
        help="Apply migrations, seed taxonomy and enqueue the curated repository seed",
    )
    ...
    score = sub.add_parser("score", help="Calculate and persist project health for one repository")
...
def main() -> None:
    ...
    if args.command == "ingest":
        ...
        print(
            json.dumps(
                {
                    "ingestion": json.loads(result.model_dump_json()),
